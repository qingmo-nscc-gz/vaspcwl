...
cd  /WORK/nscc-gz_material_4/vasp/1-1/1-2/1-3/2-1/3-1/3-2/3-3
#echo "$PWD" > log2
yhrun -p work -N 1 -n 24  ${exe_dir}/vasp_std >> /WORK/nscc-gz_material_4/vasp/1-1/1-2/1-3/2-1/3-1/3-2/3-3/log2
